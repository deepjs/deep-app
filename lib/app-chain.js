...
define(["require", "deepjs/deep"], function(require, deep) {
	...
	var constructor = function(state, app, forceContextualisation) {
		...
		if (app !== this._context.app) // if current context isn't from provided app : swap it and take one from app
	...
	var api = {
		...
		sessionModes: function(session, noContextualisation) {
			...
			var func = function(s) {
				...
				this.when(app.session.toModes(session))
				.done(function(modes) {
